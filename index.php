...
<body>
 ...
 <div id='load'>
  ...
  <div class='load'></div>
    ...
    <main>
	<nav>
		<h1><a href='#'>AKINDELE EBENEZER</a></h1>
			<ul>
			...
			<img id='nav-icon' src='images/nav-icon.PNG' alt='nav-icon'> 		
	</nav>
...
<div class='clear'></div>
  ...
  <div id='wrapper'>
    <div id='pg-3'>
	    <h1>SERVICES</h1>
	<div id='services'>
		<div id='web-dev' class='services'>
		    <img src='images/web-dev.jpg' alt='web-dev'> <br>
		...
		<div id='ui' class='services'>
		    <img src='images/ui.png' alt='ui'> <br>
		    <h2>User Interface</h2> <br>
		    <p>I have experience with responsive visual interface design. This means I can make your website layout look good on every devices. Before I build your website, I will provide some visual contents like the colors, animation, accessibilty which I'll use in your website. I'll show you the interaction design principles that I'll implement in the website.
</p>
		</div>

		<div id='ux' class='services'>
		    <img id='ux-img' src='images/ux.jpg' alt='ux'> <br> 
		    <h2 class='ux-txt'>User Experience</h2> <br>
		    <p class='ux-txt'>To effectively create a website that will pleasantly meet your needs, I will have to discuss some ideas of what I'm about to build, VERBALLY (on the phone) or by Visual Communication (physical). Through this process, you would know what your website is going to look like. Also, you would have the feel of how the website is going to be used by anyone who visits your site. This can also prompt me to get things done pretty quickly. </p>
		</div>
	</div>
    </div> 
  ...
  <div id='cert-wrapper'>
	...
	<div class='certificates'>
		<h2>COURSERA</h2>  
		<a href='coursera.html' target='_blank'><img src='images/coursera.PNG' alt='certificate-1'></a>
		<p>HTML, CSS & Javascript <br> for Web Developers</p> 
	</div>

	<div class='certificates'>
		<h2>FREE CODE CAMP</h2> 
		<a href='free-code-camp.html' target='_blank'><img src='images/free-code-camp.png' alt='certificate-2'></a>
	...
	<div id='subject'>
		...
		<input type='text' name='subject'  placeholder='Heading...'> <br><br>
	</div>
	<div id='message'> 
	...
	<div id='get-in-touch'>
		<div id='left'>
			...
			<p><img src='images/ws.png'><strong>Whatsapp:</strong> 09052757805</p><hr>
	...
	<div id='footer'>
	 ...
	 <div id='socila-media-links'>
	  <ul id='socila-media-links'>
	    ...
	    <li><a href='https://github.com/Akindele-Ebenezer' target='_blank'>Github</a></li>
